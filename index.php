...
function login(){
    ...
    document.getElementById('dz-name').innerHTML = 'Hello, ' + user.name;
    });
}
             }, {perms: 'email'});
        }
   ...
   function searchClicked()
	...
	<script type="text/javascript">
		function hideDivs(){
			...
			document.getElementById('videoWind').style.visibility = 'hidden';
			document.getElementById('evernote').style.visibility = 'hidden';
		}
		...
		function showDivs() {
			...
			document.getElementById('videoWind').style.visibility = 'visible';
			document.getElementById('evernote').style.visibility = 'visible';
		}
	</script>
</head>
...
<div class="container" >
    ...
    <div class="twitter" id="twitter">
	 ...
	 <div class="deezer" id="deezer">
		...
		<!-- Login button -->
		&nbsp;<input type="button" onclick="login();" value="Login" class="myButton" /><br/>
		<span id="dz-name"></span><br/>
		</form>
		<!-- Results -->
		<ul id="results"></ul>
		</div>
	 ...
	 <div class="evernote" id="evernote">
